...
video_fname = fullfile(matlab_root,'Flight1_DJI_0004','DJI_0004.MP4');
...
CopterCurrents_calibration_filename = fullfile(matlab_root,'CopterCurrents-master','CopterCurrents','CopterCurrents_CameraCalib','Phantom3_v1_Caltech_3840x2160.mat');
...
assert(exist(CopterCurrents_calibration_filename,'file')==2, ...
    ['Calibration file not found: ' CopterCurrents_calibration_filename]);
...
% run current fit in every square (see run_current_fit.m: 'grid' | 'adaptive_ga' | 'simple_ga')
...
print_time_graphs(stage_names,stage_times,window_timing);
%}